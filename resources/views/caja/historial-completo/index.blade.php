                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-900">Gs. 2,540,000</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-900">Gs. 125,000</p>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">V-001</td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">3 productos</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Gs. 150,000</td>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">V-002</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">2024-01-15 11:15</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">María González</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">1 producto</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Gs. 75,000</td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                                        Completado
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">V-003</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">2024-01-14 16:45</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Carlos Rodríguez</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">5 productos</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Gs. 320,000</td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                ...
                <div class="px-6 py-4 bg-white border-t border-gray-200 flex items-center justify-between">
                    <div class="text-sm text-gray-700">
                        Mostrando <span class="font-medium">1</span> a <span class="font-medium">3</span> de <span
                            class="font-medium">45</span> resultados
                    </div>
                    <div class="flex space-x-2">
                        <button class="px-3 py-1 rounded border text-sm hover:bg-gray-50">Anterior</button>
                        <button class="px-3 py-1 rounded border text-sm bg-blue-500 text-white">1</button>
