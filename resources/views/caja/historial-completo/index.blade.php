...
@section('contenido')
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4 p-6">
        ...
        @else
            <div>
                <h2 class="text-2xl font-bold text-gray-800">Tu historial de Movimientos <span class="text-sm font-normal"> | {{ ucfirst(auth()->user()->name) }}</span></h2>
            </div>
        @endif
    </div>
    <!-- Estadísticas -->
                ...
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="flex px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            Fecha
                            @if (auth()->user()->role === 'admin') @include('caja.historial-completo.icons.fecha') @endif 
                        </th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            Cliente
                        </th>
                        ...
                        <th class="flex px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            Total
                            @if (auth()->user()->role === 'admin') @include('caja.historial-completo.icons.total') @endif 
                        </th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            Estado
                        </th>
